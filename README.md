...
## 📂 Мои проекты
[Интернет‑магазин украшений «Незабудки»](https://nezabudky.ru/)
...
[B2B-лендинг «Magnar Company Inc»](https://magnar.vercel.app/)
- **Технологии:** React, TypeScript, Next.js, TailwindCSS, HeroUI, Vercel
- **Что сделал:** Разработал B2B-лендинг по макету из Figma. Реализовал адаптивную вёрстку, настроил архитектуру проекта на Next.js, создал кастомную систему типографики через Tailwind utilities и реализовал форму обратной связи с клиентской валидацией.

[Портфолио-сайт](https://pidgeots.github.io/portfolio/)
...
[Лендинг для компании по продаже солнечных панелей](https://pidgeots.github.io/sberuniversity-project/)
- **Технологии:** HTML, CSS
